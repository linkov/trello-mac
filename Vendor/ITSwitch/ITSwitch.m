...
- (void)setUpLayers {
    ...
    _knobLayer.shadowOffset = (CGSize){ .width = 0.f, .height = -0.4f };
    _knobLayer.shadowRadius = 0.0f;
    ...
    _knobInsideLayer.backgroundColor = [kKnobBackgroundColor CGColor];
    _knobInsideLayer.shadowRadius = 0.0f;
